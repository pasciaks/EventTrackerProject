...
document.getElementById("deleteCity").addEventListener("click", (event) => {
	...
	let confirm = window.confirm("Are you sure you want to delete this city? (Id: " + selectedCityId + ")");
	if (confirm) {
...
document.getElementById("bottomCloseButton").addEventListener("click", (event) => {
	event.preventDefault();
	hideModal();
});
...
document.getElementById("cancelEditButton").addEventListener("click", (event) => {
	event.preventDefault();
...
document.getElementById("editCity").addEventListener("click", (event) => {
	...
	// 	zips: document.getElementById("zips").value,
	// 	lat: document.getElementById("lat").value,
	// 	lng: document.getElementById("lng").value,
	// };

	// putCity(cityId, cityObject);
