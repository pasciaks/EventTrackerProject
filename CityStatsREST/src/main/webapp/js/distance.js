...
const setUp = () => {
  document
    ...
    .addEventListener("click", function (event) {
      ...
      let url =
        urlPrefix +
        `api/cities/distances?lat=${lat}&lng=${lng}&howFar=${miles}`;
      fetch(url)
  ...
  if (getParameterByName("capital")) {
    document.getElementById("selectedStateCapital").textContent =
      "Chosen Capital: " + getParameterByName("capital");
  } else {
    // document.getElementById('selectedStateCapital').textContent = "";
  }
  ...
  document
    .getElementById("rangePickerMiles")
    .addEventListener("input", function () {
      document.getElementById("miles").value = this.value;
    });

  document
    .getElementById("rangePickerLat")
    .addEventListener("input", function () {
      document.getElementById("lat").value = this.value;
    });

  document
    .getElementById("rangePickerLng")
    .addEventListener("input", function () {
      document.getElementById("lng").value = this.value;
    });

  document.getElementById("miles").value =
    document.getElementById("rangePickerMiles").value;
  document.getElementById("lat").value =
    document.getElementById("rangePickerLat").value;
  document.getElementById("lng").value =
    document.getElementById("rangePickerLng").value;
};
...
// NOTE: Since this script is loaded with defer, it will run after the DOM is loaded and window.onload is not necessary.
